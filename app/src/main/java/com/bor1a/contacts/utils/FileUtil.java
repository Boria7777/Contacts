...
public class FileUtil {
  final String path = Environment.getExternalStorageDirectory().getAbsolutePath() + LOG_PATH;
  public final static String LOG_PATH_NO = "BHY-Data";
  public final static String LOG_PATH = File.separator + LOG_PATH_NO + File.separator;
